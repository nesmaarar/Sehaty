...
<div class="container">
    <div class="row">
      ...
      <div class="col">
        <p class="sec1-t1">عن الموقع</p>
        <div class="sec1-t2">
            <p>صحتي" هو موقع طبي يتيح للمريض الاستشارة الطبية عن بعد يجيب عنها طبيب مختار حسب  المجال المطلوب في أسرع وقت محدد</p>
            <p>صحتي"  يعمل على تقديم أطباء مسجلين لدى الموقع بصورة فعالة حيث يتم تقديم مهاراتهم و خبراتهم و الخدمات الطبية التي يقدمها الطبيب في أي من عياداته او أماكن عمله ليتمكن المريض من الثقة به وبالتالي الحجز و المتابعة معه بشكل مباشر في وقت مناسب له
            </p>
            <p>خدمة الموقع صحتي هي الاستشارة الطبية التي تمكن المريض من الحصول على إستجابة سريعة لشكوى من مرض أو إستفسار عن إجراء طبي أو طلب نصيحة طبية في مجال معين ، لذا نرجو التنبيه إلى أننا نعلم جيداً أن الإستشارات الطبية عبر الإنترنت لا تغني عن الكشف والفحص الطبي في كثير من الحالات</p>
        </div>
      </div>
    </div>
  </div>
