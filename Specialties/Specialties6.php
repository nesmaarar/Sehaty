...
<body>
    ...
    <p class="sec1-t1">طب عام</p>
    <p class="sec1-t2">هنا قائمة  بجميع الأطباء في تخصص طب عام .</p>

    <div class="container">
        <div class="row">
          <div class="col col-6">
              
            <div class="shadow p-3 mb-5 bg-body rounded sec1-col-1">
                <img src="../IMG/sec6-img1-s6.svg" class="sec1-img" alt="">
                <div class="sec1-t22">
                <p class="sec1-t3">د.غدير ابراهيم</p>
            <p class="sec1-t4">د. غدير ابراهيم <br>
                خبرة ٣ سنوات في طوارئ <br> الجراحة ، و ٨ شهور كطبيب <br> أسرةالخبرة المهنية :بكالوريوس <br> الطب والجراحة <br>
             مكان العمل :  مستشفى الشفاء <br> في غزة <br>
               <br>
            بيانات التواصل :  0567142581 <br>
               </p>
                </div>
            <div class="d-grid gap-2 d-md-block sec1-btns1">
                <a href="chat.html"><button class="btn sec1-bt1" type="button"><i class="fa-regular fa-comment"></i></button></a> 
                <a href="date.html"><button class="btn sec1-bt2 rounded" type="button">حجز موعد</button></a>
            </div>
          </div>
